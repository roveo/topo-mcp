...
build-markdown:
	go build -tags lang_markdown -o bin/topo-markdown .
...
# Build all profiles
build-profiles: build build-go build-python build-typescript build-rust build-markdown build-backend build-frontend build-fullstack build-web build-ml
